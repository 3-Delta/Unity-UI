...
public class IEqualityComparerIntAdapter : CrossBindingAdaptor {
    public override Type BaseCLRType {
        get {
            return typeof(IEqualityComparer<int>); // 这是你想继承的那个类
        }
    }
    ...
    public class Adaptor : IEqualityComparer<int>, CrossBindingAdaptorType {
        ...
        public System.Boolean Equals(int left, int right) {
            if (!m_bEqualsGot) {
        ...
        public System.Int32 GetHashCode(int target) {
