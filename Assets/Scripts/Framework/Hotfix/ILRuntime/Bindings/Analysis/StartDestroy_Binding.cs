...
{
    unsafe class StartDestroy_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(global::StartDestroy);
        ...
        static StackObject* AssignFromStack_onTrigger_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((global::StartDestroy)o).onTrigger = @onTrigger;
