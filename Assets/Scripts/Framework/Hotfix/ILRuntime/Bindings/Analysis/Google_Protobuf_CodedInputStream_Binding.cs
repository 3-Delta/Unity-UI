...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_CodedInputStream_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ReadEnum_6);
            args = new Type[]{typeof(Google.Protobuf.IMessage)};
            method = type.GetMethod("ReadMessage", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ReadMessage_7);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, ReadString_9);
            args = new Type[]{};
        ...
        static StackObject* ReadEnum_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ReadString_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
