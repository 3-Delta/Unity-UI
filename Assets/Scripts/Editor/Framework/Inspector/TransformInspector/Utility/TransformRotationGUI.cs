...
public class TransformRotationGUI {
    ...
    public TransformRotationGUI() {
        if (transformRotationGUI == null) {
            ...
            eulerAnglesField =
                transformRotationGUIType.GetField("m_EulerAngles", BindingFlags.Instance | BindingFlags.NonPublic);
            ...
            setLocalEulerAnglesMethod = transformType.GetMethod("SetLocalEulerAngles",
