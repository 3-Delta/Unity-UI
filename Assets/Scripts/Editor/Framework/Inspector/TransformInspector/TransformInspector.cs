...
public class TransformInspector : Editor {
    private class Content {
        public static Texture2D ResetTexture =
            AssetDatabasex.LoadAssetOfType<Texture2D>(EditorGUIUtility.isProSkin
                ? "ETE_Pro_Reset"
                : "ETE_Personal_Reset");

        public static readonly GUIContent Position =
            new GUIContent("Position", "The local position of this GameObject relative to the parent.");

        public static readonly GUIContent Rotation =
            new GUIContent("Rotation", "The local rotation of this Game Object relative to the parent.");

        public static readonly GUIContent Scale =
            new GUIContent("Scale", "The local scaling of this GameObject relative to the parent.");
    ...
    public override void OnInspectorGUI() {
        ...
        using (var check = new EditorGUI.ChangeCheckScope()) {
            ...
            var newScaleX = CustomFloatField.Draw(new Rect(), dragRect, properties.Scale.vector3Value.x,
        ...
        */
        ...
        if (Mathf.Abs(position.x) > MaxDistanceFromOrigin ||
