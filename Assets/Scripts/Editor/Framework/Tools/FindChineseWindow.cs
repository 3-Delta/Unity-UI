...
// ref: https://github.com/XINCGer/UnityToolchainsTrick/blob/main/Assets/Editor/Examples/Example_46_FindChinese/FindChineseTool.cs
public class FindChineseWindow : EditorWindow {
    [MenuItem("Tools/查找代码中文")]
    public static void Pack() {
        Rect wr = new Rect(300, 400, 400, 100);
        FindChineseWindow window =
            (FindChineseWindow)EditorWindow.GetWindowWithRect(typeof(FindChineseWindow), wr, true, "查找项目中的中文字符");
        window.Show();
    }
