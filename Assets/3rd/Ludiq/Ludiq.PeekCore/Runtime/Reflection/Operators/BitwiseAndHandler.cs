...
{
	public class BitwiseAndHandler : BinaryOperatorHandler
	{
		public BitwiseAndHandler() : base(OperatorCategory.Bitwise, BinaryOperator.And, "Bitwise And", "Bitwise And", "&", "&", "op_BitwiseAnd")
		{
			...
			Handle<ushort, ushort>((a, b) => a & b, typeof(uint));
		...
		public override string GetDescriptionFormat(Type leftType, Type rightType) => "Returns the bitwise intersection of {0}.";
