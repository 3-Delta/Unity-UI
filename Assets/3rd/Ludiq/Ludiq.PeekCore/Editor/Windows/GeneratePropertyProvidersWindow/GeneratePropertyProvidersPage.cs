...
namespace Ludiq.PeekCore
{
	...
	{
		public GeneratePropertyProvidersPage(EditorWindow window) : base(window)
		{
		...
		protected override void OnContentGUI()
		{
			...
			var label = "Inspectors in Ludiq plugins can handle many custom types besides Unity primites and objects. ";
