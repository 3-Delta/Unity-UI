...
namespace Ludiq.PeekCore
{
	...
	{
		public LeftShiftHandler() : base(OperatorCategory.Bitwise, BinaryOperator.LeftShift, "Left Shift", "Left Shift", "<<", "<<", "op_LeftShift")
		{
		...
		public override string GetDescriptionFormat(Type leftType, Type rightType) => "Takes {0}, and returns the first input shifted left by the second.";
	}
}