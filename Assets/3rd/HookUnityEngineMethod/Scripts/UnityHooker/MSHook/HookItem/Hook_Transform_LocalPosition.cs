...
namespace Hook {
    public class Hook_Transform_LocalPosition : HookBase {
        public const string MethodName = "localPosition";
        ...
        protected override void DoHook() {
            ...
            var replaceMethod = type.GetMethod(nameof(_Replace), (BindingFlags)(0x0fffffff));

            var proxyMethod = type.GetMethod(nameof(_Proxy), (BindingFlags)(0x0fffffff));
