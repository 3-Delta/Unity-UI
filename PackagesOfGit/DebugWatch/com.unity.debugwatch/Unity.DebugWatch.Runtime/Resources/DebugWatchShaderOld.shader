...
//                float depth : DEPTH;
//            };
//            fragmentOutput frag_surf(v2f_surf IN) : COLOR
//            {
//                fragmentOutput o;
//                o.color = IN.color;
//                o.depth = 0;
        ...
        Pass
        {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    ...
                    {
                        SurfaceDescription surface = (SurfaceDescription)0;
                        float4 _Normalize_3B0F0124_Out_1;
                        Unity_Normalize_float4(IN.VertexColor, _Normalize_3B0F0124_Out_1);
                        float3 _ColorspaceConversion_31323FC5_Out_1;
                        Unity_ColorspaceConversion_RGB_Linear_float((_Normalize_3B0F0124_Out_1.xyz), _ColorspaceConversion_31323FC5_Out_1);
                        surface.Color = _ColorspaceConversion_31323FC5_Out_1;
                        surface.Alpha = 1;
                        surface.AlphaClipThreshold = 0.5;
